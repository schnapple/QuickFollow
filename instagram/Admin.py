...
def createFollowBotAccount():
    ...
    print('What is your instagram email?')
    username = input()
    ...
    if operationNum == '1':
        ...
        likePercentage = 50
    print("What hashtags do you want to search with? (type done to stop)")
    hashtags = []
    hashtag = input()
    ...
    print('How many people do you want to interact with per hashtag? (It isn\'t good to go above 20 instagram can catch on!)')
    numInteractions = input()
    while not numInteractions.isdigit():
        print('Not an integer!')
        print('How many people do you want to interact per hashtag? (It isn\'t good to go above 20 instagram can catch on!)')
        numInteractions = input()
